<?php 	
	...
	include($_SERVER['DOCUMENT_ROOT']."/projIntegMochuara/funcoes.php");
	noerrors();
	
	session_start();
	$_SESSION['menu'] = $_SERVER['DOCUMENT_ROOT']."/projIntegMochuara/menu.php";
	$_SESSION['caller'] = "/projIntegMochuara/";
 ?>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>Conheça o Parque Mochuara!</title>
	<meta charset="utf-8">
...
<!--CABEÇALHO/MENU-->
		<table border="0" class="table-cabecalho" align="center">		
			<tr>				
				<td width="450px">
					<center>
						<h3 class="titulo">	Venha conhecer o Mochuara!</h3>
					</center>
				</td>
			</tr>
		</table>
